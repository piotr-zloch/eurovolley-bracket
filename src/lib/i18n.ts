...
const pl = {
    ...
    groups: {
      title: "Profil",
      intro: "Twoja nazwa użytkownika, hasło i grupy typerskie.",
      groupsHeading: "Grupy typerskie",
      groupsIntro: "Opcjonalne — załóż lub dołącz do grupy, aby porównać typy ze znajomymi w rankingu.",
    ...
    matches: {
      ...
      saveError: "Nie udało się zapisać.",
      noPick: "— brak typu —",
      soon: "Najbliższe mecze",
      soonHint: "Zaczynają się w ciągu najbliższych 24 godzin. Typ możesz zmieniać do pierwszej piłki.",
      rest: "Pozostałe mecze",
    ...
    rules: {
      ...
      matchFive: "Ten sam zwycięzca, ale typ 3:2 przy 3:1 lub 3:0 (lub odwrotnie)",
...
const en: Dict = {
    ...
    groups: {
      title: "Profile",
      intro: "Your username, password and prediction groups.",
      groupsHeading: "Prediction groups",
      groupsIntro:
    ...
    matches: {
      ...
      noPick: "— no pick —",
      soon: "Next 24 hours",
      soonHint: "Starting within the next 24 hours. You can change a pick until first ball.",
      rest: "Other matches",
    ...
    rules: {
      ...
      matchFive: "Same winner, but you said 3:2 and it finished 3:1 or 3:0 (or the other way round)",
